...
public class Amazon_ClickOn1stShoe_DoAddToCart_GoToPaymentOption_With_ImplicitWait {
	...
	public static void main(String[] args)
	{
        ...
        WebElement e8=driver.findElement(By.xpath("(//input[@id='pp-GcXZBr-117'])"));
        e8.click();
        
        WebElement e9=driver.findElement(By.xpath("//a[@id='pp-8gBQHB-120']"));
        e9.click();
